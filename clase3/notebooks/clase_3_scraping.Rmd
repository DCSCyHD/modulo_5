...
La página nos trae también el botón para suscribirse. Por eso, vamos a especificar la búsqueda pidiéndole a RVest que nos traiga los elementos `<h1>` con `<class titulo-libro>`. 
...
scrapeo_anagrama <- function(listado_links){
        ...
        df <- data.frame(cbind(links, titulos, resumenes, info_extra)) #Junto en un dataframe la info conseguida
...
### Actividad
Traer de la página de Anagrama el listado de todos los autores que tienen disponibles. El resultado final debe ser una tibble en la cual la primera columna es el link al autor y la segunda, el nombre.
```{r}
###
```
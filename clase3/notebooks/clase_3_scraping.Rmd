...
### Actividad
Traer de la página de Anagrama el listado de todos los autores que tienen disponibles. El resultado final debe ser una tibble en la cual la primer columna es el link al autor y la segunda, el nombre.
```{r}
###
```
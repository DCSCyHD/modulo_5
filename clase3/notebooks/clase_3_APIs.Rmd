...
- el string de la query (esta es la parte importante): `C0=CHN&PL0=2.5&Y0=All&format=json`
...
- `format=json`: el formato de respuesta requerido

```{r}
povcalnet
```

### De json a una `tibble`
...
povcalnet_df<- povcalnet_df %>% 
                mutate(across(everything(), as.character))

povcalnet_df<- povcalnet_df %>% 
                mutate(across(c(DataYear, HC), as.numeric))

...
Vamos a normalizar, primero, los campos de texto. Con esta instrucción cambiamos el encoding de texto de los campos `text` y `title` y lo pasamos a ASCII. 
```{r}
revistas <- revistas %>%
...
- los tópicos 3, 4, 5 y 14 son predominantemente femeninos y con diferencias fuertes: entre unos 8 y 15 puntos porcentuales.

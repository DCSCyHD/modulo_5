...
- Cadena: el texto puede, por supuesto, almacenarse como cadenas, es decir, concatenaciones de caracteres, dentro de R y, a menudo, los datos de texto se leen primero en la memoria de esta forma.
...
```{r}
stop_words <- read_csv('../data/stop_words_spanish.csv') %>%
...
Fíjense cómo pasamos de aprimadamente 1.000.000 de palabras a 526.000 luego de eliminar las stop_words.
...
Podríamos evaluar ahora si Marx y Engels usan diferentes palabras en las cartas y notas y en sus libros. Para ello vamos a tener que procesar un poco el campo de `titulo`:
...
ggplot( aes(notas, libros)) +
  ...
  #geom_point(alpha = 0.05, size = 2.5, width = 0.25, height = 0.25) +

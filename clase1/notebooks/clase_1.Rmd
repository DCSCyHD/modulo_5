...
marx_df
```
¿Qué significa que este dataframe se ha impreso como un "tibble"? Un tibble es una clase moderna de dataframe dentro de R, disponible en los paquetes dplyr y tibble, que tiene un método de impresión conveniente, no convierte cadenas en factores y no usa nombres de fila. Tibbles son ideales para usar con herramientas ordenadas.
